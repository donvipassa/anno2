...
const AppContent: React.FC = () => {
  ...
  const openFileDialog = useCallback(() => {
    ...
    input.click();
  }, [loadImage, setMarkupModifiedState, setAutoAnnotationPerformed, clearAll, setMarkupFileName, showModal, closeModal, handleOpenMarkup]);
  ...
  const { handleSaveMarkup: hookHandleSaveMarkup, handleOpenMarkup: hookHandleOpenMarkup } = useFileOperations(
    showModal,
    closeModal,
    setMarkupFileName,
    setMarkupModifiedState,
